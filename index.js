...
const SEARCHES = [
  'rule34.xxx',
  'pornhub.com',
  'https://pl.xhamster.com/videos/cyprian-knapinski-i-am-fighting-myself-rocky-niebieskooki-13140827'
]

const VIDEOS = [
  'media/videos/gratulacje.mp4',
  'media/videos/ballin.mp4',
  'media/videos/5telefon.mp4',
  'media/videos/cypek.mp4',
  'media/videos/gej.mp4',
  'media/videos/iphone.mp4'
]

const FILE_DOWNLOADS = [
  'media/images/miskajestbita.gif',
  'media/images/sexjasper.png',
  'media/images/czekoladka.png'
]

const PHRASES = [
  'dlaczego ryszard kurwo jest',
  'tata jest kola',
  'miska jest nie bita',
  'miska jest czesciej bita niz auto u blacharza',
  'tubson to muj ziomek',
  'miska lubi jabluszko czokoladke papke'
]
